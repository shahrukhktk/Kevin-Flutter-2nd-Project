...
class AftonbladetScreen extends StatefulWidget {
  @override
  _AftonbladetScreenState createState() => _AftonbladetScreenState();
}

class _AftonbladetScreenState extends State<AftonbladetScreen> {
  @override
