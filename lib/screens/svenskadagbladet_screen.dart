...
class SvenskaDagbladetScreen extends StatefulWidget {
  @override
  _SvenskaDagbladetScreenState createState() => _SvenskaDagbladetScreenState();
}

class _SvenskaDagbladetScreenState extends State<SvenskaDagbladetScreen> {
  @override
            ...
            children: <Widget>[
              ...
              Column(
                children: <Widget>[
                  ...
                  Center(
                      child: Image(
                        image: AssetImage('images/img_three.png'),
                        height: 120,
                      ),
                  ),
                  SizedBox(height: 20,),
